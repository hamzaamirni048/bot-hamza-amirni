...
function smsg(conn, m, store) {
    ...
    if (m.message) {
        ...
        m.body = m.message.conversation || m.msg.caption || m.msg.text || (m.mtype == 'listResponseMessage') && m.msg.singleSelectReply.selectedRowId || (m.mtype == 'buttonsResponseMessage') && m.msg.selectedButtonId || (m.mtype == 'viewOnceMessage') && m.msg.caption || (m.mtype == 'interactiveResponseMessage') && JSON.parse(m.msg.nativeFlowResponseMessage?.paramsJson || '{}').id || (m.mtype == 'templateButtonReplyMessage') && m.msg.selectedId || m.text
